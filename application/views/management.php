...
<html lang="en" dir="ltr">
  ...
  <body>
     ...
     <a href="/shop/index.php/Main/productRegistration"><button type="button" class="btn btn-default">商品登録</button></a>
     <a href="/shop/index.php/Main/order"><button type="button" class="btn btn-default">受注台帳</button></a>
